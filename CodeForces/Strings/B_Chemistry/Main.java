package CodeForces.Strings.B_Chemistry;
...
public class Main {
      public static void main(String[] args) {
            ...
            while (t-- > 0) {
                  ...
                  // since every possible palndrome has at most 1 odd freq character
                  // i.e x <= 1 and if we remove k more so optimally we reduce odds because they
                  // can be only <= 1

                  // so x - k <= 1 --> x > k + 1 or x <= k + 1
                  if (x > k + 1)
