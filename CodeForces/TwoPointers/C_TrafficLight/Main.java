package CodeForces.TwoPointers.C_TrafficLight;
...
public class Main {
      public static int getMinTime(String s, int n, char ch) {
            // BRUTE FORCE -->
            /*
             * int ans = 0;
             * if (ch == 'g')
            ...
            int ans = 0;
            // don't need to check find for each i the next char in same string
            // instead just double the string s' = s + s just trakc the ecountered greed=n
            // idx
            ...
            for (int i = 2 * n - 1; i >= 0; i--) {
                  ...
                  if (s.charAt(idx) == ch && nextGreen != -1)
      ...
      public static void main(String[] args) {
            ...
            while (t-- > 0) {
                  ...
                  System.out.println(getMinTime(lights, n, c));
            }
