package CodeForces.Graphs.C_Dijkastra;
...
public class Main {
    ...
    public static void Dijkastra(long [] paths,ArrayList<ArrayList<Pair>> adj,long [] parent){
    ...
    public static void main(String[] args) throws Exception {
        ...
        paths[1] = 0;
        Dijkastra(paths,adj,parent);

        if(paths[n] == Long.MAX_VALUE){
        ...
        for(long p : res)System.out.print(p+" ");
    }
}
